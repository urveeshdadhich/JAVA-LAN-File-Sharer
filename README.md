...
1.  Go to the [**Releases**]([https://www.google.com/search?q=https://github.com/your-username/your-repo-name/releases](https://github.com/urveeshdadhich/JAVA-LAN-File-Sharer/releases)) page for this project.
